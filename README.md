# 📊 George Knight – Data Science Portfolio

Welcome to my portfolio! This repository highlights my featured projects from the TripleTen Data Science Bootcamp along
with other side Data Science project I have completed on my own time.  
Each project has its own dedicated repository with full code, documentation, and results.
...
- Tools: pandas, scikit-learn, matplotlib, Jupyter Notebook
...
### [OilyGiant Oil Region Profitability Analysis](https://github.com/DigitalKnight74/Oily_Giant_Mining_Company)
A data-driven exploration project to identify the most profitable and lowest-risk region for developing 200 new oil wells using linear regression modeling and statistical bootstrapping.
- Built and evaluated linear regression models for three regions to estimate oil reserves and assess model accuracy using RMSE and R² metrics.
- Designed a profit-calculation pipeline to select the top 200 predicted wells per region and compute expected economic returns under realistic development constraints.
...
- **Other:** Git/GitHub, Jupyter, Power BI, Tableau

---

## 🌐 About Me
I’m a Data Scientist in training with a background in aerospace technology maintanance, repair, technical writing and leadership.  
Passionate about machine learning, analytics, and building tools that solve real-world problems.  
